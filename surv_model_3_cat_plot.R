...
pred.model <- predict(surv_model.3.cat,type="risk",se.fit=TRUE,newdata=plot.data)
...
ggsave("~/Dropbox/Apps/Overleaf/Protest Diffusion (BLM & Alt-Right)/figures/surv_model_3_cat_1.pdf",p1, width = 9, height = 9, units = c("cm"))
...
ggsave("~/Dropbox/Apps/Overleaf/Protest Diffusion (BLM & Alt-Right)/figures/surv_model_3_cat_2.pdf",p1, width = 9, height = 9, units = c("cm"))
...
ggsave("~/Dropbox/Apps/Overleaf/Protest Diffusion (BLM & Alt-Right)/figures/surv_model_3_cat_3.pdf",p1, width = 9, height = 9, units = c("cm"))
####################################
####################################
